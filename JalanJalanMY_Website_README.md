# JalanJalanMY — Landing Page Website

A modern, bold app landing page for JalanJalanMY — built to support affiliate program applications (Klook, Agoda) and showcase the product professionally.
...
- **Subtext**: No more juggling 10 apps. JalanJalanMY searches Agoda, Klook, and Google Maps all at once.
...
- Copyright right: © 2025 JalanJalanMY. All rights reserved.
...
5. Your URL: `https://JalanJalanMY.vercel.app`

**Optional custom domain:**

- Buy `JalanJalanMYapp.com` (~RM60/year on Namecheap)
...
_JalanJalanMY · Agentic AI Travel Planner for Malaysia_  
_Final Year Project · Universiti Teknologi PETRONAS_
